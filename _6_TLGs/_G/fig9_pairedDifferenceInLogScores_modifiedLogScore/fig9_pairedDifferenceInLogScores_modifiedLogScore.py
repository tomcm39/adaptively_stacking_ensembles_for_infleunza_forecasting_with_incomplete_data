...
def plotLogScoresBySeason(ax):
    ...
    deRandomEffectsData = pd.read_csv('../../_T/tab2_ensembleComparisons_modifiedLogScore/tableData/deRslts.csv')
    ...
    dsRandomEffectsData = pd.read_csv('../../_T/tab2_ensembleComparisons_modifiedLogScore/tableData/dsRslts.csv')
...
if __name__ == "__main__":
    ...
    ax.text(0.4,-0.085,'Eq./Stat. model better',ha='right',va='top',transform=ax.transAxes,fontsize=6.0)
    ...
    plt.savefig('fig9_pairedDifferenceInLogScores_modifiedLogScore.pdf')
    plt.savefig('fig9_pairedDifferenceInLogScores_modifiedLogScore.png')
    plt.savefig('fig9_pairedDifferenceInLogScores_modifiedLogScore.eps')
    plt.close()
