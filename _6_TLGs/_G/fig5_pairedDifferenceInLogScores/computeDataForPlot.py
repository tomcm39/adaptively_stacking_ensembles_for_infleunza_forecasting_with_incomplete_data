...
if __name__ == "__main__":
    ...
    dynamic.rename(columns = {'logScore':'logScoreDynamic'},inplace=True)
    static.rename(columns = {'logScore':'logScoreStatic'},inplace=True)
    equal.rename(columns = {'logScore':'logScoreEqual'},inplace=True)
    ...
    logDifs.to_parquet('./plotData/logDifs.pq')
