...
if __name__ == "__main__":
    ...
    allWtData.to_csv('./analysisData/ensembleWeights__staticweight_{:6.4f}.csv'.format(priorPercent))
    allLogScores.to_csv('./analysisData/ensembleScores__staticscore_{:6.4f}.csv'.format(priorPercent))
